...
using namespace std;
ModuleText::ModuleText(bool start_enabled)
{
}
...
void ModuleText::print(const font_data & ft_font, float x, float y, const char * fmt, ...)
{
...
void font_data::make_dlist(FT_Face face, char ch, GLuint list_base, GLuint * tex_base)
{
